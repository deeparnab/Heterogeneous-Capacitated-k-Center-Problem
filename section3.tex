...
\end{theorem}
	\begin{proof} (Sketch) In the Shmoys-Tardos rounding~\cite{shmoys-tardos} of the assignment LP, one converts the instance into a bipartite matching instance where one side we have the jobs $J$ with 
