...
%\comment{Do we want to add a line on how we get these results}
We complement this by showing (Theorem~\ref{fthm:conf-ig}, \Cref{fsec:conf-ig}) that the integrality gap of the configuration LP is $\Omega(\log D/\log\log D)$.
