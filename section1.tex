...
come specified value $L$, and the objective is to minimize the maximum intra-cluster distance. This problem introduced by Bar-Ilan et al~\cite{bar-ilan kotsarz peleg 1993} has many applications~\cite{lupton maley yong, morgan levin, murthy kam}. %see khuller-sussmann paper for these refs.
