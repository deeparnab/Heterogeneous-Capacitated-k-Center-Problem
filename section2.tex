...
The main crux of the above proof is the following decomposition theorem obtained by the technique of region growing which was first used in the context of sparsest and multi cut problems~\cite{LeightonRao,GVY}.
